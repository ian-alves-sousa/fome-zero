...
def bar_1(df1):
    ...
    graf1 = px.bar(graf1.head(data_slider), x='cuisines',y='aggregate_rating',text_auto=True,labels={'cuisines':'Tipo de Culinária','aggregate_rating':'Média da Avaliação Média'},title='Top 10 Melhores Tipos de Culiárias')
    return graf1
...
def bar_2(df1):
    ...
    graf1 = px.bar(graf1.head(data_slider), x='cuisines',y='aggregate_rating',text_auto=True,labels={'cuisines':'Tipo de Culinária','aggregate_rating':'Média da Avaliação Média'},title='Top 10 Piores Tipos de Culiárias')
    return graf1
